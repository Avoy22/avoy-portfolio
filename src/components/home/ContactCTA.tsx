...
export function ContactCTA() {
  return (
    <Section spacing="md">
      <Container>
        <div className="relative overflow-hidden rounded-4xl border border-white/10 bg-linear-to-br from-white/8 via-white/2.5 to-transparent p-10 sm:p-16 lg:p-20">
          <div
            aria-hidden
            className="pointer-events-none absolute inset-0 grid-bg mask-[radial-gradient(ellipse_60%_50%_at_50%_50%,black,transparent_75%)] opacity-40"
          />
          <div
            aria-hidden
            className="pointer-events-none absolute -top-40 left-1/2 h-120 w-120 -translate-x-1/2 animate-aurora rounded-full bg-[radial-gradient(circle_at_center,rgba(167,139,250,0.26),transparent_60%)] blur-3xl"
          />
          <div
            aria-hidden
            className="pointer-events-none absolute -bottom-32 right-[5%] h-95 w-95 animate-aurora rounded-full bg-[radial-gradient(circle_at_center,rgba(34,211,238,0.18),transparent_60%)] blur-3xl"
            style={{ animationDelay: "-6s" }}
          />
          <div
            aria-hidden
            className="pointer-events-none absolute -top-32 left-[8%] h-70 w-70 animate-aurora rounded-full bg-[radial-gradient(circle_at_center,rgba(109,140,255,0.18),transparent_60%)] blur-3xl"
