            ...
            return (
              <Reveal key={service.slug} delay={(index % 2) * 0.06}>
                <Link href="/services" className="group block h-full">
                  <Card asChild className="glass-card interactive-card relative h-full overflow-hidden rounded-2xl border-white/8 bg-transparent p-6 sm:p-7">
                    <article>
        ...
        <Reveal>
          <div className="mt-10 flex justify-center sm:mt-12">
            <Link
              ...
              className="group inline-flex max-w-full flex-wrap items-center justify-center gap-2 rounded-full border border-white/10 bg-white/3 px-5 py-2.5 text-center text-[13.5px] text-foreground-muted backdrop-blur transition hover:-translate-y-0.5 hover:border-white/25 hover:bg-white/6 hover:text-white motion-reduce:hover:translate-y-0"
            >
